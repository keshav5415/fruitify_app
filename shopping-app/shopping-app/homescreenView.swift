...
struct homescreenView: View
{
    var body: some View 
    {
        ...
        .navigationBarHidden(true) // applies only on ZStack
        /*
         this is done because we were getting a 'back' option on the 'homescreen' view each time when i m
         opening 'homescreenView()' through 'onboardingscreenView()', then there is a back option in top-left
         corner , because of which the whole 'VStack' is getting pushed to bottom creating a disturbed
         image of the app . so this is done to remove the navigation bar .
        */
    }
}
